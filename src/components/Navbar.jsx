      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a href="#about" className="text-gray-600 dark:text-gray-300 hover:text-[#CD1C18] dark:hover:text-[#FFA896] font-medium transition-colors">About Us</a>
      ...
      {isOpen && (
        <div className="md:hidden bg-white dark:bg-[#38000A] border-b border-gray-200 dark:border-gray-800">
          <div className="px-4 pt-2 pb-6 space-y-2">
            ...
            <a href="#about" onClick={() => setIsOpen(false)} className="block px-3 py-3 text-lg font-medium text-gray-900 dark:text-white hover:text-[#CD1C18] dark:hover:text-[#FFA896]">About Us</a>
